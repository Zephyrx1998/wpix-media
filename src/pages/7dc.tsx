...
const SevenDC = () => {
  ...
  const portfolioItems = [{
    ...
    image: socialMediaKit
  }, {
    id: 3,
    title: "Corporate Brochure",
    category: "Print Design",
    image: corporateBrochure
  }, {
    id: 4,
    title: "App Interface",
    category: "UI/UX",
  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="py-16 bg-accent/20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            return <div key={index} className="bg-card rounded-2xl p-6 shadow-soft border border-primary/10 hover:shadow-medium transition-all duration-300 group">
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <Button variant="outline" className="group" onClick={() => window.open('https://drive.google.com/file/d/1zxOcgBU1msSq1Jjprv-7Vzzf7kfMNCgv/view?usp=sharing', '_blank', 'noopener,noreferrer')}>
              View Full Portfolio
              <ArrowRight className="h-4 w-4 ml-2 group-hover:translate-x-1 transition-transform" />
            </Button>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {portfolioItems.map(item => <div key={item.id} className="bg-card rounded-2xl overflow-hidden shadow-soft border border-primary/10 hover:shadow-medium transition-all duration-300 cursor-pointer group">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="overflow-hidden">
            <div className="flex animate-scroll whitespace-nowrap">
              {[...clientLogos, ...clientLogos, ...clientLogos].map((client, index) => <div key={index} className="bg-card px-6 py-4 rounded-lg shadow-soft border border-primary/10 w-40 h-20 flex items-center justify-center flex-shrink-0 mx-4">
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => <div key={index} className="bg-card rounded-2xl p-6 shadow-soft border border-primary/10">
                <div className="flex items-center gap-2 mb-4">
                  {[...Array(5)].map((_, i) => <Star key={i} className="h-4 w-4 text-primary fill-current" />)}
                </div>
