...
const ContactSection = () => {
  return (
    <section id="contact" className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-accent/20 to-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-start">
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-4 sm:space-y-6">
                <a 
                  ...
                  className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-card rounded-xl shadow-soft border border-primary/10 active:scale-[0.98] transition-all touch-manipulation"
                >
                ...
                <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-card rounded-xl shadow-soft border border-primary/10">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary/10 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div className="bg-gradient-to-r from-primary/5 to-primary-dark/5 rounded-xl p-4 sm:p-6 border border-primary/10">
          ...
          <ScrollReveal animation="fade-left" delay={200}>
            <div className="bg-card rounded-2xl sm:rounded-3xl p-5 sm:p-6 md:p-8 shadow-medium border border-primary/10">
              <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-foreground">Start Your Project</h3>
              
              <div className="space-y-4 sm:space-y-6">
                <div className="grid grid-cols-2 gap-3 sm:gap-4">
                  <div className="text-center p-3 sm:p-4 bg-primary/5 rounded-xl border border-primary/10 active:scale-[0.98] transition-transform touch-manipulation">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-2 sm:gap-3">
                    {[
                      ...
                      <div 
                        key={index}
                        className="p-3 sm:p-4 bg-secondary rounded-lg text-center text-xs sm:text-sm text-foreground hover:bg-primary hover:text-primary-foreground active:bg-primary active:text-primary-foreground transition-colors cursor-pointer touch-manipulation"
                      >
                        {service}
                      </div>
                    ))}
