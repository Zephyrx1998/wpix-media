...
const ApproachSection = () => {
  ...
  return (
    <section id="services" className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-background to-accent/20">
      <div className="container mx-auto px-4">
          ...
          {steps.map((step, index) => {
            ...
            return (
              <ScrollReveal key={step.title} animation="fade-up" delay={index * 100}>
                <div 
                  className="relative bg-card rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 shadow-soft border border-primary/10 hover:shadow-medium transition-all duration-300 group text-center h-full active:scale-[0.98] touch-manipulation"
                >
                  {/* Step Number */}
                  <div className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 w-8 h-8 sm:w-10 md:w-12 sm:h-10 md:h-12 bg-gradient-to-br from-primary to-primary-dark rounded-full flex items-center justify-center shadow-medium">
        ...
        <ScrollReveal animation="fade-up" delay={400}>
          <div className="mt-12 sm:mt-16 md:mt-20 text-center">
            <div className="bg-gradient-to-r from-primary/5 to-primary-dark/5 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 border border-primary/10">
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-4">
                <div className="bg-card rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-6 shadow-soft border border-primary/10">
