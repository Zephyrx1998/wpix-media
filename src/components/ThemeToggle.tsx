...
const ThemeToggle = () => {
  ...
  return (
    <Button
      ...
      className="fixed top-20 right-4 md:right-6 z-[60] rounded-full bg-background/80 backdrop-blur-sm border border-border shadow-lg hover:shadow-xl transition-all duration-300"
    >
      {theme === "dark" ? (
