...
const ThemeToggle = () => {
  ...
  return (
    <Button
      ...
      className="fixed top-4 right-4 z-50 rounded-full bg-background/80 backdrop-blur-sm border border-border shadow-lg hover:shadow-xl transition-all duration-300"
    >
      {theme === "dark" ? (
